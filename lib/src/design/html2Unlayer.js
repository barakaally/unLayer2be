    ...
    constructor(data) {
        ...
        */
        ...
        this.getContents = (column) => Array.from((0, htmlParser_1.parseChildren)(column.children, true)).map((content, i) => {
            ...
            const imgStyle = (0, htmlParser_1.parseInlineStyle)(content === null || content === void 0 ? void 0 : content.querySelector("img"));
            return {
                type: type,
                values: Object.assign(Object.assign({}, Object.assign(Object.assign({}, this.getStyle(content.style, content.outerHTML, `u_content_${type}_${i + 1}`)), { containerPadding: "" })), {
                    src: {
                        ...
                        height: (_c = content === null || content === void 0 ? void 0 : content.querySelector("img")) === null || _c === void 0 ? void 0 : _c.height,
                    }
                })
            };
        });
