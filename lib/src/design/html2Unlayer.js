        ...
        */
        this.getCells = (columns) => {
            ...
            const cells = columns === null || columns === void 0 ? void 0 : columns.map(x => {
                var _a;
                return (_a = Array.from((0, htmlParser_1.parseChildren)(x.children))) === null || _a === void 0 ? void 0 : _a.map((y) => { var _a; return y.classList.contains("unlayer2be") ? -1 : Number((_a = y === null || y === void 0 ? void 0 : y.style["min-width"]) === null || _a === void 0 ? void 0 : _a.replace(/[a-zA-Z]+/g, "")); });
            });
            return ((_a = cells[0]) === null || _a === void 0 ? void 0 : _a.includes(-1)) ? [12] :
                ((_b = cells[0]) === null || _b === void 0 ? void 0 : _b.length) ? (_c = cells[0]) === null || _c === void 0 ? void 0 : _c.map(x => (!isNaN(x) && x) ? Math.round((x / Math.min(...cells[cells.length - 1].map(y => y == 0 ? 12 : y)))) : 12) :
                    [12];
        };
