        ...
        */
        this.getCells = (columns) => {
            const cells = columns === null || columns === void 0 ? void 0 : columns.map(x => {
                var _a;
                return (_a = Array.from((0, htmlParser_1.parseChildren)(x.children))) === null || _a === void 0 ? void 0 : _a.map((y) => { var _a, _b; return y.classList.contains("2be") ? -1 : Number((_b = ((_a = y === null || y === void 0 ? void 0 : y.style["min-width"]) !== null && _a !== void 0 ? _a : y === null || y === void 0 ? void 0 : y.style["width"])) === null || _b === void 0 ? void 0 : _b.replace(/[a-zA-Z]+/g, "")); });
            });
