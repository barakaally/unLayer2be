        ...
        */
        this.getCells = (columns) => {
            const cells = columns === null || columns === void 0 ? void 0 : columns.map(x => {
                var _a;
                return (_a = Array.from((0, htmlParser_1.parseChildren)(x.children))) === null || _a === void 0 ? void 0 : _a.map((y) => { var _a, _b; return y.classList.contains("unlayer2be") ? -1 : Number((_b = ((_a = y === null || y === void 0 ? void 0 : y.style["width"]) !== null && _a !== void 0 ? _a : y === null || y === void 0 ? void 0 : y.style["min-width"])) === null || _b === void 0 ? void 0 : _b.replace(/[a-zA-Z]+/g, "")); });
            });
        ...
        this.getColumns = (columns) => Array.from(columns).map((column, i) => {
            ...
            const padding = Array.from((0, htmlParser_1.parseChildren)(column.children))[0].parentElement.parentElement.style["padding"];
            style.padding = padding ? padding : "10px 10px 10px 10px";
            console.log(i, style.padding);
            return {
        ...
        this.calculateColumnsRatio = (cells) => {
            var _a, _b, _c;
            return ((_a = cells[0]) === null || _a === void 0 ? void 0 : _a.includes(-1)) ? [12] :
                ((_b = cells[0]) === null || _b === void 0 ? void 0 : _b.length) ? (_c = cells[0]) === null || _c === void 0 ? void 0 : _c.map((x) => (!isNaN(x) && x) ? Math.round((x / Math.min(...cells[0].map((y) => y == 0 ? 12 : y)))) : 12) :
                    [12];
        };
        this.getContents = (column) => Array.from((0, htmlParser_1.parseChildren)(column.children)).map((content, i) => {
            var _a;
            const type = this.getContentType(content);
            this.countElement(type);
            return {
                type: type,
                values: Object.assign(Object.assign({}, Object.assign(Object.assign({}, this.getStyle(content.style, content.outerHTML, `u_content_${type}_${i + 1}`)), { containerPadding: "" })), {
                    src: {
    ...
    getDesign() {
        ...
        design.body = {
            rows: (0, htmlParser_1.parseRows)(this.body).map((row, i) => {
                ...
                return {
                    cells: this.getCells(Array.from(hasMultipleCells ? (_f = row.children[0]) === null || _f === void 0 ? void 0 : _f.children : row.children)),
