...
class Html2Unlayer {
    constructor() {
        this.getFirstChildren = (body) => {
            var _a;
            let a = Array.from((_a = body === null || body === void 0 ? void 0 : body.children) !== null && _a !== void 0 ? _a : []).filter(x => x.tagName.toUpperCase() != "SCRIPT")[0];
            if (a) {
                if ((a === null || a === void 0 ? void 0 : a.children.length) > 1)
                    return Array.from(a === null || a === void 0 ? void 0 : a.children);
                let b = a === null || a === void 0 ? void 0 : a.children[0];
                if (b) {
                    if ((b === null || b === void 0 ? void 0 : b.children.length) > 1)
                        return Array.from(b === null || b === void 0 ? void 0 : b.children);
                    let c = b === null || b === void 0 ? void 0 : b.children[0];
                    if (c) {
                        console.log("0", c.outerHTML);
                        if ((c === null || c === void 0 ? void 0 : c.children.length) > 1)
                            return Array.from(c === null || c === void 0 ? void 0 : c.children);
                        let d = c === null || c === void 0 ? void 0 : c.children[0];
                        if (!d)
                            d = this.document.createElement("div");
                        if ((d === null || d === void 0 ? void 0 : d.children.length) > 1)
                            return Array.from(d === null || d === void 0 ? void 0 : d.children);
                        c.prepend(d);
                        console.log("1", d.outerHTML);
        ...
        */
        this.getCells = (columns) => {
            ...
            return (_a = cells === null || cells === void 0 ? void 0 : cells.map(x => !isNaN(x) ? Math.round((x / Math.min(...cells))) : 1)) !== null && _a !== void 0 ? _a : [12];
        };
    ...
    from(data) {
        let design = {};
        this.document = htmlParser_1.HtmlParser.parse(data);
        const body = this.document.querySelector("body");
        console.log(this.getFirstChildren(body));
        design.body = {
