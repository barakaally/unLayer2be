        ...
        */
        this.getCells = (columns) => {
            const cells = columns === null || columns === void 0 ? void 0 : columns.map(x => {
                var _a;
                return (_a = Array.from((0, htmlParser_1.parseChildren)(x.children))) === null || _a === void 0 ? void 0 : _a.map((y) => { var _a; return y.classList.contains("unlayer2be") ? -1 : Number((_a = y === null || y === void 0 ? void 0 : y.style["width"]) === null || _a === void 0 ? void 0 : _a.replace(/[a-zA-Z]+/g, "")); });
            });
