...
class Unlayerhtml {
    ...
    from(data) {
        ...
        design.body = {
            rows: Array.from((_a = body === null || body === void 0 ? void 0 : body.children) !== null && _a !== void 0 ? _a : []).map((row) => {
                return {
                    cells: [12],
                    columns: Array.from(row.children).map((column) => {
                        return {
                            contents: Array.from(column).map((content, i) => {
                                return {
                                    type: "text",
                                    values: this.htmlStyle2Unlayer(content.style, content.outerHTML, `u_content_${i}`)
                                };
                            }),
                            values: this.htmlStyle2Unlayer(column === null || column === void 0 ? void 0 : column.style, '', `u_column_${1}`),
                        };
                    }),
