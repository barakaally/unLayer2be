...
function parseChildren(children, isContent = false, parent = null) {
    var _a, _b;
    //console.log(isContent,children[0].querySelector("img"))
    if (children.length == 1 &&
        children.length == 1 && children[0].tagName.toUpperCase() != "A" &&
        ((isContent && isSubElement(children[0])) || (isContent && ((_a = children[0]) === null || _a === void 0 ? void 0 : _a.querySelector("img"))) || !isContent)) {
        return parseChildren((_b = children[0]) === null || _b === void 0 ? void 0 : _b.children, isContent, children[0]);
    }
...
function isSubElement(element) {
    return ["IMG", "SPAN", "TR", "TD", "TBODY", "TABLE", "A", "P", "H1", "H2", "H3", "H4", "H5", "H6"].
        some(x => {
        var _a, _b;
        return (x == element.tagName.toUpperCase()) ||
            (x == ((_b = (_a = element === null || element === void 0 ? void 0 : element.parentElement) === null || _a === void 0 ? void 0 : _a.tagName) === null || _b === void 0 ? void 0 : _b.toUpperCase()));
    });
}
