...
function parseChildren(children, parent = null) {
    var _a;
    if (children.length == 1) {
        return parseChildren((_a = children[0]) === null || _a === void 0 ? void 0 : _a.children, children[0]);
    }
...
function addContainer(element, isContent = false) {
    var _a;
