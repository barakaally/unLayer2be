...
function parseChildren(children, isContent = false, parent = null) {
    ...
    if (children.length == 1 &&
        ...
        ((isContent && isSubElement(children[0])) ||
            (isContent && ((_b = children[0]) === null || _b === void 0 ? void 0 : _b.querySelector("img"))) ||
            (!isContent))) {
        return parseChildren((_c = children[0]) === null || _c === void 0 ? void 0 : _c.children, isContent, children[0]);
    }
    ...
    if (children.length > 1 &&
        CONTENTS.includes((_d = children[0]) === null || _d === void 0 ? void 0 : _d.tagName.toUpperCase())) {
        return [addContainer(children[0].parentElement)];
    }
    if (children.length > 1 &&
        INLINEELEMENTS.includes((_e = children[0]) === null || _e === void 0 ? void 0 : _e.tagName.toUpperCase())) {
        return [children[0]];
    }
